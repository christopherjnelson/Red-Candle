...
const Navbar = () => {
  ...
  return (
    <div className="rounded-div flex items-center justify-between h-20 font-bold">
      <Link to="/">
        <img className="w-24 block dark:hidden" src={logoBlack} alt="" />
        <img className="w-24 hidden dark:block" src={logoWhite} alt="" />
      </Link>
      ...
      <div
        className={
          nav
            ? "md:hidden fixed left-0 top-20 flex flex-col items-center justify-between w-full h-[90%] bg-primary ease-in duration-300 z-20"
      ...
      >
        ...
        {user?.email ? (
          ...
          <div className="flex flex-col w-full p-4">
            ...
            <Link onClick={navHandler} to="/register">
